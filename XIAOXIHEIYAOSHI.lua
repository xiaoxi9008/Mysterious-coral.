...
function Library:CreateWindow(WindowInfo)
    ...
    local OnlyIconsMode = WindowInfo.OnlyIcons or false  -- 新增：只显示图标模式
    ...
    local function ApplySidebarLayout()
        ...
        for _, LabelObject in ipairs(LayoutRefs.TabLabels) do
            LabelObject.Visible = (not IsCompact) and (not OnlyIconsMode)  -- 如果开启只显示图标模式，永远隐藏文字
        end
    ...
    function Window:AddTab(...)
        ...
        do
            ...
            TabLabel = New("TextLabel", {
                ...
                TextTransparency = 0.5,
                TextXAlignment = Enum.TextXAlignment.Left,
                Visible = (not LayoutState.IsCompact) and (not OnlyIconsMode),  -- 修改：如果开启只显示图标模式，永远不显示文字
                Parent = TabButton,
            })
